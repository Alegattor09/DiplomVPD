# ___________________________________________VPC
...
resource "yandex_vpc_gateway" "nat_gateway" {
  name = "project-gateway-netology"
  shared_egress_gateway {}
}

# ___________________________________________Subnet
resource "yandex_vpc_subnet" "subnet_web-1" {
  name           = "subnet_web-1"
  zone           = "ru-central1-a"
  network_id     = yandex_vpc_network.dipnet.id
  v4_cidr_blocks = ["10.1.1.0/28"]
...
# _________________________________________________target_group
...
# _________________________________________________backend_group
...
# _________________________________________________HTTP router
